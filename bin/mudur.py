...
LANGUAGES = {
    ...
    "ar"    : Language("sy",         "iso01.16",   "8859-6", "ar_EG.UTF-8"),
    "ast"   : Language("ES",         "iso01.15",   "8859-15","ast_ES.utf8"),
    "bg"    : Language("bg",         "cp1251",     "",        "bg_BG.utf8"),
    "cs"    : Language("CZ",         "",           "8859-2",  "cs_CZ.utf8"),
    "da"    : Language("dk",         "",           "8859-1",  "da_DK.utf8"),
    "eu"    : Language("es",         "",           "8859-1",  "eu_ES.utf8"),
    "he"    : Language("il",         "",           "8859-8",  "he_IL.utf8"),
    "hi"    : Language("in",         "",           "",        "hi_IN.utf8"),
    "hr"    : Language("hr",         "",           "8859-2",  "hr_HR.utf8"),
    ...
    "th"    : Language("th",         "",           "tis620",  "th_TH.utf8"),
